...
PIN_TYPES = ["input", "output", "bidirectional", "tri_state", "passive", 
             "free", "unspecified", "power_in", "power_out", "open_collector", "no_connect"]
...
# Helper functions
def random_string(min_length=5, max_length=20, chars=string.ascii_letters + string.digits + "_"):
...
def generate_random_symbol(max_pins=50):
    ...
    unit_names = [random_string(1, 10, string.ascii_letters + string.digits + "_") for _ in range(num_units)]
